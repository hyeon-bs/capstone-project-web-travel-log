...
### 로그인 화면
<img src="docs/static/로그인 화면.png" width="650" height="400" />
<img src="docs/static/로그인 팝업.png" width="650" height="400" />

사용자 인증을 진행하는 화면으로 아이디와 비밀번호 미일치 시 팝업을 통해 예외 원인을 안내합니다.

### 회원가입 및 데이터베이스 반영 화면
<img src="docs/static/회원가입 데이터베이스.png" height="250" />
<img src="docs/static/화원가입 화면.png" height="400" />

신규 회원 정보를 입력하는 폼 화면이며 가입 완료 시 MySQL DB에 정상적으로 데이터가 적재됨을 확인할 수 있습니다.

### 캘린더 메인 화면
<img src="docs/static/캘린더 화면.png" width="650" height="400" />

오늘의 날짜를 직관적으로 제공하며 일지 작성 및 게시판 이동 등의 핵심 허브 역할을 수행하는 메인 인터페이스입니다.

### 게시판 및 데이터 조회 화면
<img src="docs/static/게시판 데이터 베이스.png" width="650" height="400" />
...
| 팀원 | 역할 | 기여도 |
|------|------|--------|
| 백소현 | 최종 보고서 및 발표 자료 작성 / 전체 UI 제작 / 서버 구현(Tomcat/MySQL) / 환경 변수 설정 / 프로그램 개발 및 테스트 | 100% |
| 한승규 | 최종 보고서 및 발표 자료 작성 / 요구사항 분석 / 자료수집 / 의견 조율 | 75% |
| 이채영 | 최종 보고서 및 발표 자료 작성 / 작업 상황 피드백 / UI 설계 기획 / 프로젝트 관리 | 75% |
| 오수진 | 개선 방향 의견 제시 / 내용 구성 / 자료수집 / 테스트 | 75% |
